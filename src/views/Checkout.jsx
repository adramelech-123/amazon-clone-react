...
const Checkout = () => {
  ...
  const decreaseQuantity = (productId) => {
    // Dispatch an action to decrement the quantity of a product
                  ...
                  <div className="grid grid-cols-12 divide-y divide-gray-400 mr-4">
                    <div className="col-span-10 grid grid-cols-8 divide-y divide-gray-400">
                      ...
                      <div className="col-span-6">
                        ...
                        <div>
                          <button onClick={() => decreaseQuantity(product.id)} className="text-sm xl:text-base font-semibold rounded text-blue-500 my-2">Delete</button>
                        </div>
                        <div className="grid grid-cols-3 w-20 text-center">
                          <div className="text-xl xl:text-2xl bg-gray-400 rounded-l pb-1">
                            -
                          </div>
                          <div className="text-lg xl:text-xl bg-gray-200">
                            {product.quantity}
                          </div>
                          <div className="text-xl xl:text-2xl bg-gray-400 rounded-r">
                            +
                          </div>
                        </div>
                      </div>
